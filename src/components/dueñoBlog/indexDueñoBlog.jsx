                ...
                <div className="row">
                    ...
                    <div className="col-12">
                        <div className="btnRedactar">
                            <button type="button" className="btn btn-primary"><svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" fill="currentColor" className="bi bi-pencil-square" viewBox="0 0 16 16">
